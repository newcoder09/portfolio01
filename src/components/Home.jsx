...
{/* py is the padding to allow the responsiveness when moving different sizes */}
    ...
    <p className='text-[#F9F6EE] py-4 max-w-[700]'> I have just graduated from The School of Code. From the moment I wrote my first Hello World.
     I knew I wanted to learn more. At the moment I am expanding on the 
     skills introduced at Bootcamp.</p>
     <div>
       <button className='text-black group border-2 px-6 py-3 my-2 flex items-center hover:bg-pink-500 hover:border-pink-500'>
       View Projects
